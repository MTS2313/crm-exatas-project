                    ...
                    <div className='header-container'>
                         <nav className="navigation">
                              ...
                              <ul className={menu}>
                                   ...
                                   <a href={'#'} onClick={() => toggleMenu()}><li className="link main">Home</li></a>
                                   <a href={'#aboutus'} onClick={() => toggleMenu()}><li className="link main">About-us</li></a>
                                   <a href={'#prices'} onClick={() => toggleMenu()}><li className="link main">Prices</li></a>
                                   <a href={'#contact'} onClick={() => toggleMenu()}><li className="link main">Contact-us</li></a>
