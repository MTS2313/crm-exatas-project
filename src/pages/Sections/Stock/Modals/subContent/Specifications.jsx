    ...
    <div className="specifications-container">
      {confirmDelete === false ? (
          ...
          <div className="row">
            <div className="text-wrapper">
              <span className="text-description">
                Specifications are additional properties that can be added to
                your store's products or SKUs. A specification is used to create
                site browsing filters and to differentiate SKUs and products
        ...
        <div className="confirm-delete-content">
          Tem certeza que deseja deletar <span className="item-to-delete">{additional[confirmDelete].name}</span> ?
          <div className="action-buttons">
            <button className="cancel" onClick={() => setConfirmDelete(false)}>
              <span>Cancel</span>
            </button>
            <button className="delete" onClick={() => setConfirmDelete(false)}>
              <MdOutlineDeleteOutline size={"1rem"} color="#fff" />
              <span>Delete</span>
            </button>
          </div>
        </div>
